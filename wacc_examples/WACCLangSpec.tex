...
DummyType attempt to access an undeclared variable results in \hl{... ??? ...}
...
\begin{itemize}
 ...
 \item If the assignment value is a pair element \synt{pair-elem} then the expression passed to the pair element 
       ...
       DummyType attempt to dereference a \lit{null} reference should generate a runtime error. 
 \end{itemize}
...
DummyType other type of occurrence of whitespace is ignored by the compiler.
